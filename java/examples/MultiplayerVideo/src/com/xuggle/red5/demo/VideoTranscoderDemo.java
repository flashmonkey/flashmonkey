...
import org.red5.core.HelloWorld;
...
public class VideoTranscoderDemo
{
  ...
  final private IVideoPictureListener mVideoPictureListener = new VideoPictureListener()
  {
    ...
    {
    	//System.out.println("renderer: " + game.getImageData());
  ...
  {
	  System.out.println("startTranscodingStream(" + aStream.getPublishedName() + "," + aScope.getName() + ")");
  ...
  {
	  System.out.println("stopTranscodingStream(" + aStream.getPublishedName() + "," + aScope.getName() + ")");
