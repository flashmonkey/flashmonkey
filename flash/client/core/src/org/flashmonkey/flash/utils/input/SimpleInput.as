...
package org.flashmonkey.flash.utils.input 
{
	 ...
	 */
	public class SimpleInput extends NetObject implements IInput
	{		
		...
		public function SimpleInput(moveForward : Boolean = false, moveBackward : Boolean = false, 
		...
		{
			return new SimpleInput( _moveForward, _moveBackward, 
